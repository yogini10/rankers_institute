...
const String _svg_q0rcxt =
    '<svg viewBox="315.5 655.5 1.0 63.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(315.5, 655.5)" d="M 0 0 L 0 63" fill="none" stroke="#6dd2ff" stroke-width="10" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
