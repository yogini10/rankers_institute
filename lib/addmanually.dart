...
class addmanually extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        ...
        body: Center(child: Container( width: g.width * 0.9,
            height: g.height * 0.9,
            decoration: BoxDecoration(
              border: Border.all(width: 0.5),
              borderRadius: BorderRadius.circular(g.width * 0.1),
              color: Color(0xffffffff).withOpacity(0.55),
            ),
            child: Padding(
              padding: EdgeInsets.only(top: g.height*0.035),
              child: Column(
