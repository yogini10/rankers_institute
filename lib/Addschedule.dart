...
const String _svg_lhuxn =
    '<svg viewBox="284.5 687.5 63.0 1.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(284.5, 687.5)" d="M 0 0 L 33.46875 0 L 63 0" fill="none" stroke="#57c5df" stroke-width="10" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
